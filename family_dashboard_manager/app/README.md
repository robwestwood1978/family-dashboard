...
- a two-floor floorplan engine that can use a private isometric/cutaway plan or a read-only Home Assistant vacuum-map camera, with polygon room hotspots, state-coloured/brightness-aware light overlays and selected-room read-only room status;
